...
[[nodiscard]] const QHash<QString, QString>& catalog() {
    static const QHash<QString, QString> kCatalog{
        ...
        {QStringLiteral("file_backup.journal_missing"),
         QStringLiteral("aegra.error.file_backup.journal_missing")},
        {QStringLiteral("file_backup.journal_reset"),
         QStringLiteral("aegra.error.file_backup.journal_reset")},
        {QStringLiteral("file_backup.journal_wrapped"),
         QStringLiteral("aegra.error.file_backup.journal_wrapped")},
        {QStringLiteral("file_backup.journal_inaccessible"),
         QStringLiteral("aegra.error.file_backup.journal_inaccessible")},
